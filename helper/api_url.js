...
//export const api_url = "http://192.168.88.249/ow.randev.ovh/";
...
export const viewAPI =
  "https://www.passion-campagne.projets-omega.net/modules/easycarousels/commande.php";
...
export const api_get_spec_prices_product =
  api_url + api_path_file + "getSpecificPricesProduct&use_tax_sp=1"; // &idCombination_sp=987987&idProduct_sp=876&quantity_sp=3  http://localhost:8888/passioncampagne/mobile_data/root_url.php?type=getSpecificPricesProduct&idCombination_sp=32988&idProduct_sp=5185&quantity_sp=3&use_tax_sp=1
...
export const api_get_promotion_state =
  api_url + api_path_file + "getPromotionState";
//  Send email footer
export const api_send_email = api_url + api_path_file + "sendEmail";

// get promo products
export const getAllProductPromo =
  api_url + api_path_file + "getAllProductPromo";
// get latest product
...
export const getProductsManufacturer =
  api_url + api_path_file + "getProductsManufacturer";
...
export const api_get_wishlist_categories =
  api_url + api_wishlist + "wishlist_categories&IdCustomer=";
