...
import CardCategorydetailssubsub from './card_category';



class Flatlistercategorydetailssubsub extends Component {
  ...
  renderItem = ( item ) => {
    return  (
      <CardCategorydetailssubsub item={item.item} showDetail={this.showDetail}/>
    )
  }
...
export default Flatlistercategorydetailssubsub;