    ...
    render() {
        ...
        return (
            <ImageBackground
                ...
                source={{uri: 'https://www.passion-campagne.com/bg-presentation-2.jpg'}}
            >
                <Swiper 
                ...
                >   
                    <View style={styles.slide1} >
                        {/* <View > */}
                            <TouchableOpacity style={{width: '100%'}} activeOpacity={1} onPress={()=> {same_category({IdCategorie: 76, titre: 'Vêtements de chasse', text: 'Vêtement'}) }}>
                                <Image
                                    ...
                                    source={{ uri: 'https://www.passion-campagne.com/12491-medium_default/pull-col-zip-vert-laksen-norfolk.jpg' }}
                                />
                            </TouchableOpacity>
                    ...
                    <View style={styles.slide2} >
                        <TouchableOpacity  style={{width: '100%'}} activeOpacity={1} onPress={()=> {same_category({IdCategorie: 102, titre: 'Chaussures de chasse',text: 'Chaussures'}) }}>
                            <Image
                                ...
                                source={{ uri: 'https://www.passion-campagne.com/11584-medium_default/chaussures-tres-chaudes-ariat-catalyst-vx-gtx-8-400g.jpg' }}
                            />
                        </TouchableOpacity> 
                    ...
                    <View style={styles.slide3} > 
                        <TouchableOpacity  style={{width: '100%'}} activeOpacity={1} onPress={()=> { same_category({IdCategorie: 42, titre: 'Sacs de chasse',text: 'Sac'})}}>
                            <Image
