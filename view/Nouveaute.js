...
import {api_get_search_result,api_products_by_id_categorie, api_get_promotion_state,getLatestProducts } from '../helper/api_url';
...
class Nouveaute extends React.Component {
    ...
    getProduct = async () => {
        var products = null; 
            products = await fetch_url_get(getLatestProducts);
            this.setState({
